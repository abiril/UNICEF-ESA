...
'NE Brazil grids 10km x 10km using GHSL grids and data
...
data <- na.omit(data)
head(data)
names(data)[c(8:15)] <- c("smod.10", "smod.11", "smod.12", "smod.13", "smod.21", "smod.22", "smod.23", "smod.30")
...
saveRDS(rf, file = "Outputs/NE_Brazil_10km_school_indicator_RF_AllVars_ghsl.rds")
rf <- readRDS(file = "Outputs/NE_Brazil_10km_school_indicator_RF_AllVars_ghsl.rds")
...
saveRDS(tuned_hyper, file = "Outputs/NE_Brazil_10km_school_indicator_RF_Tuned_Hyperparameters.rds")

tuned_hyper <- readRDS(file = "Outputs/NE_Brazil_10km_school_indicator_RF_Tuned_Hyperparameters.rds")
tuned_hyper
...
saveRDS(rf2, file = "Outputs/NE_Brazil_10km_school_indicator_RF_Tuned.rds")
rf2 <- readRDS(file = "Outputs/NE_Brazil_10km_school_indicator_RF_Tuned.rds")
...
pred.country <- st_intersection(pred.sf, NE_Brazil)
...
saveRDS(pred.all, file = "Outputs/NE_Brazil_10km_school_indicator_RF_Pred.RDS")
...
saveRDS(country.r, file = "Outputs/NE_Brazil_10km_school_indicator_RF_Pred_Raster.RDS")
...
saveRDS(rf3, file = "Outputs/NE_Brazil_10km_school_indicator_RF_Pred.rds")
rf3 <- readRDS(file = "Outputs/NE_Brazil_10km_school_indicator_RF_Pred.rds")
...
save(pred.prob.data, file = "Outputs/NE_Brazil_10km_school_indicator_RF_Pred_Prob.RData")
load(file = "Outputs/NE_Brazil_10km_school_indicator_RF_Pred_Prob.RData")
