...
setwd("C:/Users/air21/OneDrive - Imperial College London/Documents/UNICEF-ESA/GitHub/UNICEF-ESA")
...
load(file = "Outputs/BEN_10km_school_count_nonspatialRF_tuned_model.RData")
model.non.spatial <- model.non.spatial.tuned
...
ggsave("Outputs/BEN_10km_NonSpatial_MoransI.png")
