####  Randon Forest in R on ALL DATA
...
rf <- randomForest(NUMPOINTS ~ x + y + land + pop + built_s + built_v ,#+ smod.10 + smod.11 + smod.12 + smod.13 + smod.21 + smod.22 + smod.23 + smod.30, 
            data = data, proximity = FALSE) 

rf

save(rf, file = "/home/azureuser/cloudfiles/code/Users/ariley/Data/Schools/School_Counts/Outputs/NE_1km_school_count_RF_AllData.RData")
saveRDS(rf, file = "/home/azureuser/cloudfiles/code/Users/ariley/Data/Schools/School_Counts/Outputs/NE_1km_school_count_RF_AllData.rds")

rf <- readRDS(file = "/home/azureuser/cloudfiles/code/Users/ariley/Data/Schools/School_Counts/Outputs/NE_1km_school_count_RF_AllData.rds")
...
predicted <- cbind(p1, data)
confusionMatrix(p1, predicted$NUMPOINTS)

predicted$diff <- as.factor(as.numeric(predicted$p1) - as.numeric(predicted$NUMPOINTS))
names(predicted)
